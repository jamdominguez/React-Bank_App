...
const Title = (props) => {    
    if (props.icon) {
        return (
            <div>            
                <svg className="bi bi-building" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <span> </span>
                <span className={props.size}>{props.label}</span>        
            </div>
        )
    } else {
        return(
